...
Route::get('solaris/dormitories',[CompanyController::class,'dormitories'])->middleware('auth');
Route::get('solaris/add/dormitories',[CompanyController::class,'createDormitories'])->middleware('auth');
Route::get('solaris/universities',[CompanyController::class,'universities'])->middleware('auth');
Route::get('solaris/add/universities',[CompanyController::class,'createUniversities'])->middleware('auth');
