...
<head>
    ...
    <link href="/panel.css?v={{rand(0,999)}}" rel="stylesheet">
    ...
    <div id="topbar">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-5">
                    <ul class="top-menu">
                        <li><a href="#"><i class="fas fa-map-marker-alt fa-fw"></i>Platform'a Hoşgeldiniz</a></li>
                        <li><a href="tel:+(90) 216 577 69 21"><i class="fas fa-phone fa-fw"></i>+(90) 216 577 69 21</a>
                        </li>
                    </ul>
                </div>
                                    ...
                                    <div class="widget-myaccount">
                                        <div class="d-block">
                                            <img class="avatar avatar-lg"
                                                 src="https://images.pexels.com/photos/8951408/pexels-photo-8951408.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500">
                                        </div>
                                        <span>Kullanıcı Adı</span>
                                        <p class="text-muted"></p>
                                        <ul class="text-left">
                                            <li><a href="/my-profile"><i class="icon-user"></i>Profilim</a></li>
                                            <li><a href="/company"><i class="fas fa-business-time"></i>İşletmem</a></li>
                                            <li><a href="/settings"><i class="fas fa-cog"></i>Ayarlar</a></li>
                                            <li><a href="/logout"><i class="fas fa-sign-out-alt"></i>Çıkış Yap</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                    ...
                    <div class="container">
                        <nav>
                            <ul>
                                ...
                                <li>
                                    <div>
                                        <a href="/logout" class="button-info-first"><i class="fas fa-sign-out-alt"></i>&nbsp;ÇIKIŞ
                                            YAP</a>
                                    </div>
                                </li>
                            </ul>
